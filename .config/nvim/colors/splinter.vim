...
let s:style = get(g:, "splinter_style", "default")
let g:colors_name = "splinter"
...
let s:gui.comment    = { "default": "#30383F" }
let s:gui.search     = { "default": "#4C626A" }
...
call s:hi("StatusLineNC",       s:gui.cursorline,    s:gui.none,    "none")
call s:hi("StatusLineTerm",     s:gui.background,    s:gui.none,    "none")
call s:hi("StatusLineTemrNC",   s:gui.cursorline,    s:gui.none,    "none")
...
call s:hi("LineNr",       s:gui.cursorline, s:gui.none,       "")
call s:hi("CursorLine",   s:gui.none,       s:gui.none,       "")
call s:hi("CursorLineNr", s:gui.foreground, s:gui.none,   "bold")
...
call s:hi("Comment",      s:gui.comment,    "",               "bold,italic")
...
call s:hi("typescriptTypeBracket",          s:gui.blue,        "", "")
...
call s:hi("typescriptCall",                 s:gui.green,       "", "")
...
call s:hi("typescriptLineComment",          s:gui.comment,     "", "bold,italic")
call s:hi("typescriptComment",              s:gui.comment,     "", "bold,italic")
call s:hi("typescriptDotComment",           s:gui.comment,     "", "bold,italic")
call s:hi("typescriptCommentTodo",          s:gui.comment,     "", "bold,italic")
call s:hi("typescriptGlobal",               s:gui.blue,        "", "bold")
call s:hi("typescriptStatementKeyword",     s:gui.blue,        "", "bold")
...
call s:hi("jsCommentTodo",     s:gui.comment,     "", "bold,italic")
